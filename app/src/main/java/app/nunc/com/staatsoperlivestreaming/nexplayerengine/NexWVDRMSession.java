...
public class NexWVDRMSession {
    ...
    public interface IWVDRMSessionListener {
        void processResonsde(byte[] arrResponse, int cach);
    }
    ...
    public void processRequest(int type, byte[] reqMsg, int cach, Object url)
    {
        ...
        NexLog.e(TAG, "cach : " + Integer.toHexString(cach));
