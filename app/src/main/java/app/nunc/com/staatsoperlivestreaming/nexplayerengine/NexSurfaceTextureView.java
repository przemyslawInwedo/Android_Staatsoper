...
import app.nunc.com.staatsoperlivestreaming.nexplayerengine.gles.NexEglSurface;
import app.nunc.com.staatsoperlivestreaming.nexplayerengine.gles.NexGLUtil;
import app.nunc.com.staatsoperlivestreaming.nexplayerengine.gles.NexVideo2dProgram;
 ...
 */
@TargetApi(14)
public class NexSurfaceTextureView extends SurfaceView implements SurfaceHolder.Callback, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        ...
        if(mUseSurfaceTexture) {
            ...
            if(mSurfaceTextureBinder != null)
                ...
                ((NexPlayer)mWeakPlayer.get()).setDisplay(null, 0);
            }
        }
    }
