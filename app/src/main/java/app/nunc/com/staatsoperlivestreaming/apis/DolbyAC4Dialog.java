...
public class DolbyAC4Dialog {
    ...
    private int mDolbyAC4MainAssoPref = 32;
	...
	private void resetUIComponents() {
		...
		mDolbyAC4MainAssoPrefSeekbar.setProgress(mDolbyAC4MainAssoPref);
		mDolbyAC4MainAssoPrefTextView.setText(String.valueOf(mDolbyAC4MainAssoPref-32));
	...
	private void setupUIComponents(View view) {
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(mActivity,
				android.R.layout.simple_spinner_item, id.textview, mActivity.getResources().getStringArray(R.array.pref_dolby_ac4_virtualization_entries));
		...
		saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				mDolbyAC4MainAssoPref = mDolbyAC4MainAssoPrefSeekbar.getProgress();
