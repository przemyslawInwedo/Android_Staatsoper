...
public class NexPreferenceData {
	...
	protected void getDefaultPreferenceData() {
		...
		//NexMediaDrm start
		mEnableMediaDRM = true;
		//NexMediaDrm end
		//NexWVSWDrm start
		mPrintSWDRMAllLogs = false;
		mEnableWVSWDRM = true;
		//NexWVSWDrm end

		//Widevine start
		mWidevineDRMServerKey = mContext.getString(R.string.pref_media_drm_server_key_uri_default);
		//Widevine end
	...
	public void loadPreferenceData() {
		...
		//NexMediaDrm start
		mEnableMediaDRM = mPref.getBoolean(mContext.getString(R.string.pref_enable_media_drm_key), mEnableMediaDRM);
		mWidevineDRMServerKey = mPref.getString(mContext.getString(R.string.pref_media_drm_server_key_uri_key), mWidevineDRMServerKey);
		//NexMediaDrm end
		//NexWVSWDrm start
		mEnableWVSWDRM = mPref.getBoolean(mContext.getString(R.string.pref_enable_sw_drm_Key), mEnableWVSWDRM);
		mPrintSWDRMAllLogs = mPref.getBoolean(mContext.getString(R.string.pref_enable_sw_drm_print_all_logs_key), mPrintSWDRMAllLogs);
//		mWidevineDRMServerKey = mPref.getString(mContext.getString(R.string.pref_swdrm_server_key_uri_key), mWidevineDRMServerKey);
		//NexWVSWDrm end
