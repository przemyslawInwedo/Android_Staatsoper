...
public class DolbyAC3Dialog {
	...
	private void setupUIComponents(View view) {
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(mActivity,
				android.R.layout.simple_spinner_item, id.textview, mActivity.getResources().getStringArray(R.array.pref_dolby_ac3_post_processing_entries));
		...
		adapter = new ArrayAdapter<String>(mActivity,
				android.R.layout.simple_spinner_item, id.textview, mActivity.getResources().getStringArray(R.array.pref_dolby_ac3_end_point_entries));
