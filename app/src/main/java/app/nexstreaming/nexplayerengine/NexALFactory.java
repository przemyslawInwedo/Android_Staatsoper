...
public final class NexALFactory {
    ...
    public boolean init( Context context, String strModel, String strRenderMode, int logLevel, int colorDepth) {
        ...
        int initRet = initialize_native(new WeakReference<NexALFactory>(this), strLibPath,strNativePath,strDeviceModel, strDeviceRenderMode, iPlatform, iCPUInfo, logLevel, colorDepth );
        if(initRet == 0)
...
/** 
     ...
     *            \link app.nexstreaming.nexplayerengine nexplayerengine\endlink.
     *              - <b>1:</b> RGBA 8888
     *              - <b>4:</b> RGB 565 
     */
    private native int initialize_native(Object alfactory_this,String strLibPath,String strNativeLibPath, String strDeviceModel, String strDeviceRenderMode,
                                            int sdkInfo, int cpuInfo, int logLevel, int pixelFormat);
    /**
     ...
     * 
     * To get the error constant of a given code, call:  {@link app.nexstreaming.nexplayerengine.NexALFactory.NexALFactoryErrorCode#fromIntegerValue(int) fromIntegerValue(int)}.
     *
     * To get the error description given an error constant, call:  {@link app.nexstreaming.nexplayerengine.NexALFactory.NexALFactoryErrorCode#getDesc() getDesc()}.
     * 
     * To get the error code given an error constant, call:  {@link app.nexstreaming.nexplayerengine.NexALFactory.NexALFactoryErrorCode#getIntegerCode() getIntegerCode()}.
     *
